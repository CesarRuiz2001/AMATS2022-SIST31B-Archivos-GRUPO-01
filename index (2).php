...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(bg-fondo.jpg);" data-stellar-background-ratio="0.5">
		  <div class="home-slider owl-carousel">
	      <div class="slider-item js-fullheight">
	      	<div class="overlay"></div>
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/inicio.png" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class=>
		          		<span class="subheading"> BARBERIA DANIELA</span>
			            <h1 class="mb-4"> Santa Ana, El palmar</h1>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class=>
		          		<span class="subheading"> BARBERIA DANIELA</span>
			            <h1 class="mb-4">Santa Ana, El palmar </h1>
			            <p class="mb-4">Cortes de cabello, Recorte de barba Y Aplicado de mascarillas faciales.</p>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
				...
				<br><br><br><br>
					<div class="one-third">
						<div class="img" style="background-image: url(images/pnginicio.png);">
						</div>
					</div>
    		</div>
    	</div>
