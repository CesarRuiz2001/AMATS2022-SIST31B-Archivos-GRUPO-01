...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 style=color:black class="title1">Citas Aceptadas</h3>
...
<?php
$ret=mysqli_query($con,"select *from  tblcitas where estado='1'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th>
						  ...
						  <a href="eliminar-caceptadas.php?ID=<?php echo $row['ID']?>" class="btn btn-danger"> Eliminar  </a>
