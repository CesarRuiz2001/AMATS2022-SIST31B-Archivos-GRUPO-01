...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 style=color:black class="title1">Citas Rechazadas</h3>
...
<?php
$ret=mysqli_query($con,"select *from  tblcitas where estado='2'");
$cnt=1;
...
?>
						 ...
						 <a href="eliminar-crechazadas.php?ID=<?php echo $row['ID']?>" class="btn btn-danger"> Eliminar  </a>
