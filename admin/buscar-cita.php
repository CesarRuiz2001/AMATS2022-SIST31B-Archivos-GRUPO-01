...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 style=color:black class="title1">Buscar Citas</h3>
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Buscar por Número de Cita</label> 
...
<?php
$ret=mysqli_query($con,"select *from  tblcitas where no_citas like '%$sdata%' || nombre like '%$sdata%' || Telefono like '%$sdata%'");
...
?>
						 ...
						 <td><?php  echo $row['no_citas'];?></td>
						  ...
						  <td><a href="ver-citas.php?viewid=<?php echo $row['ID'];?>">Detalle de Cita</a></td>
						   </tr>   <?php 
$cnt=$cnt+1;
} } else { ?>
  <tr>
    <td colspan="8"> No se encotro nada</td>
