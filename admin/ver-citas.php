...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblcitas set observacion='$remark',estado='$status' where ID='$cid'");
    if ($query) {
    $msg="Todos los detalles han sido actualizados";
    echo "<script>window.location.href = 'vista-citas.php'</script>"; 
  }
  else
    {
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 style=color:black class="title1">Detalle de Cita</h3>
...
<tr>
    <th>Observación :</th>
    <td>
    <textarea name="remark" placeholder="" rows="12" cols="14" class="form-control wd-450" value="¡Gracias por preferirnos!"></textarea></td>
   </tr>
...
<tr>
<th>Fecha</th>
<td><?php echo $row['fecha-coment']; ?>  </td></tr>
